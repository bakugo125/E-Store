<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Users/Customer.master" AutoEventWireup="true" CodeBehind="ViewProduct.aspx.cs" Inherits="OnlineStore.Pages.Users.ViewProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content5" runat="server">
    ...
    <div class="cell colspan6">
        ...
        <asp:GridView runat="server" ID="gridPhotos" AutoGenerateColumns="False" CssClass="table striped hovered border bordered" data-role="datatable" data-seraching="false" OnRowCommand="gridPhotos_RowCommand">
            ...
            <asp:Button runat="server" ID="btnSelectedToCart" CssClass="button primary full-size" Text="Add Selected Items to Cart" OnClick="btnSelectedToCart_Click" />
